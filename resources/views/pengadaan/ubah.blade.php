...
<div class="modal fade" id="ubahModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/ubahPengadaan" method="post" rule="form" enctype="multipart/form-data">
        {{csrf_field()}}
      ...
      <div class="modal-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control nama_pengadaan" id="u_nama_pengadaan" name="u_nama_pengadaan" placeholder="Masukkan Nama Pengadaan Baru">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control anggaran" id="u_anggaran" name="u_anggaran" placeholder="Masukkan Nama anggaran" onkeyup="curency2()">
                  </div>
