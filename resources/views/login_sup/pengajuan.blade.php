...
<div class="modal fade" id="pengajuanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form action="/tambahPengajuan" method="post" rule="form" enctype="multipart/form-data">
        {{csrf_field()}}
      ...
      <div class="modal-body">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control anggaran" id="anggaran" name="anggaran" placeholder="Masukkan Nama anggaran" onkeyup="curency()">
                  </div>
