        ...
        if($tokenDb >0){
            ...
            if($pengadaan > 0){
                ...
                if(Storage::delete($dataPengadaan->gambar)){
                    ...
                    if(M_Pengadaan::where('id_pengadaan',$id)->update(["gambar"=>"-"])){ return redirect('/listPengadaan')->with('berhasil','gambar berhasil dihapus');
      ...
      public function hapusPengadaan($id){
        ...
        if($tokenDb >0){
            ...
            if($pengadaan > 0){
                ...
                if(Storage::delete($dataPengadaan->gambar)){
                    if(M_Pengadaan::where('id_pengadaan',$id)->delete()){ return redirect('/listPengadaan')->with('berhasil','data berhasil dihapus');
